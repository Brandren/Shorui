...
<style>
    ...
    .userauth-content {
	 ...
	 <nav>
		<div class="navbar">
			<div class="logo"><a href="index.php"><img src="images/logo.png" alt="logo" id="hover"/></a></div>
			<span class="navlink"><a href="index.php">Home</a></span>
			<div class="dropdown" id="dropdown-btn">
				<span><a href="#discover">Discover</a></span>
...
<li id="logintxt"><a href="login.php"><i class="fas">&#xf2bd;</i></a></li>
-->